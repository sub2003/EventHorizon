...
<nav class="eh-navbar">
    <div class="eh-navbar-inner">
        ...
        <ul class="eh-nav-links">
            ...
            <li><a href="${pageContext.request.contextPath}/register.jsp" class="eh-nav-btn-outline active"><i class="fa-solid fa-user-plus"></i><span>Register</span></a></li>
        </ul>
    </div>
</nav>
...
<div class="auth-wrapper">
    <div class="auth-card">
        <div class="auth-logo"><span class="auth-brand-mark"><i class="fa-solid fa-leaf"></i></span><span>EVENTHORIZON</span></div>
