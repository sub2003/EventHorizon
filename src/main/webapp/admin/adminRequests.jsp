...
<div class="panel">
    ...
    %>
        <div class="alert error">Failed to approve request. The email may already exist or the request may no longer be pending.</div>
    <%
        } else if ("rejectFailed".equals(error)) {
    %>
        <div class="alert error">Failed to reject request. The request may no longer be pending.</div>
    <%
        }
    %>
